<?php
    ...
    if (isset($_REQUEST['submit'])){
        extract($_REQUEST);
        $purchase = $user->purchase_admin($Blood_Bank, $Blood_Group,$Number_Bottle, $Date_Purchase, $Total_Price);
		     if ($purchase) {
...
<div class="wrapper">
 <div class="header">
  ...
  <table>
   ...
   <tr>
    <td>Blood Bank:</td>
 <td><input type="text" name="Blood_Bank" placeholder="Enter blood bank name"  autofocus maxlength="30" style="background-color:#FCF" id="bb" /> <span style="color:red" id="errbb"></span></td>
        </tr>
...
<span style="color:red" id="errbg"></span></td>
 ...
 <td><input type="date" name="Date_Purchase" maxlength="15" style="background-color:#FCF" id="dp" /> <span style="color:red" id="errdp"></span></td>
        </tr>
	   ...
	   function validate()
{
	...
	if(bb=='')
	{
		$('#errbb').html("*Please enter blood bank name !!");
		return false;
	}
	...
	if(dp=='')
	{
		$('#errdp').html("*Please enter date of purchase !!");
		return false;
	}
	if(tp=='')
	{
